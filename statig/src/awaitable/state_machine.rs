...
where
    ...
    for<'sub> <Self as into_state_machine::IntoStateMachine>::Superstate<'sub>: awaitable::superstate::Superstate<Self>,
...
where
    ...
    for<'sub> <M as into_state_machine::IntoStateMachine>::Superstate<'sub>: awaitable::superstate::Superstate<M>,
...
where
    M: IntoStateMachineExt + Clone,
    M::State: Clone, 
    for<'sub> <M as into_state_machine::IntoStateMachine>::Superstate<'sub>: awaitable::superstate::Superstate<M> + Send,
    <M as into_state_machine::IntoStateMachine>::State: awaitable::state::State<M>
